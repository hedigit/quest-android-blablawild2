...
public class ItineraryRecyclerAdapter extends RecyclerView.Adapter <ItineraryRecyclerAdapter.ViewHolder>{
    ...
    public ArrayList<ItineraryListActivity.ItineraryModel> mItineraries;
    ...
    public void onBindViewHolder(ItineraryRecyclerAdapter.ViewHolder holder, int position) {
        ItineraryListActivity.ItineraryModel itineraryModel = mItineraries.get(position);
    ...
    public ItineraryRecyclerAdapter(ArrayList<ItineraryListActivity.ItineraryModel> itineraries){
